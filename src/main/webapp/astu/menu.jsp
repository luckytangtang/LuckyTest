	...
	<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0'>
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
		  <!-- 1 -->
	      <dl class='bitem'>
	        <dt onclick='showHide("items1_1")'><b>文档管理</b></dt>
	        <dd style='display:block' class='sitem' id='items1_1'>
                  <ul class='sitemu'>
	             <li><a href='<%=path %>/doc/paginate' target='main'>文档记录</a> </li>
				  <li><a href="<%=path%>/doc/uploadFile"target='main'>文档上传</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
...
<script type="text/javascript">
	function logout() {
		if(confirm("确定退出当前账号！")){
			window.close();
			parent.window.location.href="<%=path%>/users/logout";
